...
OWNER_NAME = getenv("OWNER_NAME", "shubham kumar")
OWNER_USERNAME = getenv("OWNER_USERNAME", "Robottech_Memeberr")
SOURCE_CODE = getenv("SOURCE_CODE", "https://t.me/RoboTez")
STRING_SESSION = getenv("STRING_SESSION", "session")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "2048314609").split()))
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/RoboTezX")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "https://t.me/RoboTez")

# 𝐃𝐨 𝐍𝐨𝐭 𝐂𝐡𝐚𝐧𝐠𝐞 𝐓𝐡𝐢𝐬 𝐋𝐢𝐧𝐞𝐬 // 𝐈𝐠𝐧𝐨𝐫𝐞 𝐓𝐡𝐢𝐬 (𝐁𝐢𝐤𝐚𝐬𝐡 𝐇𝐚𝐥𝐝𝐞𝐫) 
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
PROFILE_CHANNEL = getenv("PROFILE_CHANNEL", "https://t.me/Robottech_Memeberr")
